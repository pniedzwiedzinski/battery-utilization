...
\title[Akumulatory]{Sposoby magazynowania energii} % The short title in the optional parameter appears at the bottom of every slide, the full title in the main parameter is only on the title page

\subtitle{Rodzaje ogniw} % Presentation subtitle, remove this command if a subtitle isn't required
...
\date[08.01.2024]{Podstawy Konstrukcji Maszyn \\ 8 styczeń 2024}
